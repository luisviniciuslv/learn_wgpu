...
pub struct State {
    ...
    window: Arc<Window>,
    // Placeholder para pipeline de renderizacao.
...
impl State {
    ...
    pub async fn new(window: Arc<Window>) -> anyhow::Result<Self> {
        ...
        // Carrega o shader WGSL embutido no binario.
        let shader = device.create_shader_module(wgpu::include_wgsl!("shader.wgsl"));
        // Layout do pipeline (sem bind groups por enquanto).
        ...
        // Pipeline que liga os shaders e define o estado de rasterizacao.
        let render_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            label: Some("Render Pipeline"),
            layout: Some(&render_pipeline_layout),
            vertex: wgpu::VertexState {
                module: &shader,
                // Entrada do vertex shader no WGSL.
                entry_point: Some("vs_main"),
                // Sem vertex buffers; os vertices sao gerados pelo vertex_index.
                buffers: &[],
                compilation_options: wgpu::PipelineCompilationOptions::default(),
            },
            fragment: Some(wgpu::FragmentState {
                module: &shader,
                // Entrada do fragment shader no WGSL.
            ...
            // TriangleList: cada grupo de 3 vertices vira um triangulo.
            topology: wgpu::PrimitiveTopology::TriangleList,
            strip_index_format: None,
            // Vertices em sentido anti-horario sao a frente do triangulo.
            ...
            // Sem depth/stencil porque so desenhamos um triangulo simples.
            depth_stencil: None,
    ...
    fn render(&mut self) -> anyhow::Result<()> {
        ...
        });
        {
            ...
            // Seleciona o pipeline com os shaders configurados.
            render_pass.set_pipeline(&self.render_pipeline);
            // Desenha 3 vertices (um triangulo) e 1 instancia.
